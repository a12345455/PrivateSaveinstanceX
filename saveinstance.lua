...
getgenv().gethiddenpropertygethiddenproperty = gethiddenproperty -- funny haha
...
--- @field IgnoreNotArchivable boolean -- Ignores the Archivable property and saves Non-Archivable instances. ___Default:___false
...
local function synsaveinstance(CustomOptions, CustomOptions2)
	...
	local savebuffer, savebuffer_size =
		{
			'<!-- Saved by PrivateSaveinstanceX --><roblox version="4">',
		}, 2
